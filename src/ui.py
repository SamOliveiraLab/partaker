...
from tracking import track_cells, visualize_cell_tracks, overlay_tracks_on_images
...
class TabWidgetApp(QMainWindow):
    ...
    def track_cells_over_time(self):
        ...
        try:
            ...
            # **Overlay Tracks on Images**
            # visualize_cell_tracks(segmented_imgs, self.tracked_cells)
            overlay_tracks_on_images(segmented_imgs, self.tracked_cells, save_video=True)
